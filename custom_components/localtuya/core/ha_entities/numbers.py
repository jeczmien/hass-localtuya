...
NUMBERS: dict[str, tuple[LocalTuyaEntity, ...]] = {
    ...
    "dgnbj": (
        ...
        LocalTuyaEntity(
            id=(DPCode.MAXTEMP_SET, DPCode.UPPER_TEMP),
        ...
        LocalTuyaEntity(
            id=(DPCode.MINITEMP_SET, DPCode.LOWER_TEMP),
        ...
        LocalTuyaEntity(
            ...
            entity_category=EntityCategory.CONFIG,
            custom_configs=localtuya_numbers(1, 10, unit=PERCENTAGE),
        ),
        LocalTuyaEntity(
            id="report_sensitivity",
